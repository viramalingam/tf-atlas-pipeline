...
task run_mean_prediction {
    ...
    command {
        ...
        echo "python /my_scripts/tf-atlas-pipeline/anvil/modeling/mean_prediction.py" --prediction_h5s ${sep=',' prediction_h5s} --generate_bigwigs --chrom_sizes chrom_sizes --output_dir /mean_prediction_data
        
        python /my_scripts/tf-atlas-pipeline/anvil/modeling/mean_prediction.py --prediction_h5s ${sep=',' prediction_h5s} --generate_bigwigs --chrom_sizes chrom_sizes --output_dir /mean_prediction_data
