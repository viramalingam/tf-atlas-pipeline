...
task run_fastpredict {
	...
	command {
		...
		git clone --depth 1 --branch dev_test_abhi_models https://github.com/viramalingam/tf-atlas-pipeline.git
...
runtime {
		docker: 'vivekramalingam/tf-atlas:gcp-modeling_dev_test_abhi_models'
		memory: 32 + "GB"
		bootDiskSizeGb: 50
