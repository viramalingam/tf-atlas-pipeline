...
task run_modelling {
	...
	command {
		...
		cd /; mkdir my_scripts
		cd /my_scripts
		git clone --depth 1 --branch dev_fixed_log_bias_weight https://github.com/viramalingam/tf-atlas-pipeline.git
	...
	runtime {
		docker: 'vivekramalingam/tf-atlas:gcp-modeling_dev_fixed_log_bias_weight'
		memory: 32 + "GB"
		bootDiskSizeGb: 50
