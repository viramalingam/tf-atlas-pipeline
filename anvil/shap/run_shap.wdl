...
task run_shap {
	...
	command {
		...
		cd /; mkdir my_scripts
		cd /my_scripts
		git clone --depth 1 --branch dev_shap_save_precision https://github.com/viramalingam/tf-atlas-pipeline.git
	...
	runtime {
		docker: 'vivekramalingam/tf-atlas:gcp-modeling_dev_shap_save_precision'
		memory: 30 + "GB"
		bootDiskSizeGb: 50
