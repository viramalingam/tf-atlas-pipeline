...
task run_modisco {
	...
	command {
		...
		cd /; mkdir my_scripts
		cd /my_scripts
		git clone --depth 1 --branch v2.0.0-rc.3 https://github.com/viramalingam/tf-atlas-pipeline.git
	...
	runtime {
		docker: 'vivekramalingam/tf-atlas:gcp-modisco_modiscolite_v2.0.7m'
		memory: mem_gb + "GB"
		cpu: number_of_cpus
		bootDiskSizeGb: 50
